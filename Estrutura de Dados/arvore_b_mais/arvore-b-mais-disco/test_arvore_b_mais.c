...
BEGIN_TESTS();
    ...
    if (!skip) {
        ...
        TListaNosInternos *tabIndice = cria_nos_internos(D, 3,
                                                         ...
                                                         cria_no_interno(D, 4, 0, 1, 2 * 2 + 1, //esse noh eh a nova raiz da arvore
                                                                         0 * tamanho_no_folha(D),
                                                                         2 * tamanho_no_folha(D),
                                                                         3 * tamanho_no_folha(D),
                                                                         4 * tamanho_no_folha(D),
        ...
        TListaNosFolhas *tabDados = cria_nos_folhas(D, 6,
                                                    ...
                                                    cria_no_folha(D, 1 * tamanho_no_interno(D), 4 * tamanho_no_folha(D), 2,
                                                                  cliente(37, "Leonardo"),
                                                                  cliente(38, "Karla")
                                                    ),
                                                    cria_no_folha(D, 1 * tamanho_no_interno(D), 5 * tamanho_no_folha(D), 2,
                                                                  cliente(39, "Mario"),
                                                                  cliente(50, "Ricardo")
                                                    ),
